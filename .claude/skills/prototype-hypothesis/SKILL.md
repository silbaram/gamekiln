...
Complete only when the file begins with a `Tests: R<N>` anchor citing an existing macro risk (including appended R4+ risks), and failure and success signals are observable during play or prototype runs.
