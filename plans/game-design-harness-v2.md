...
| ② AI가 production-quality 코드 생성 | 스킬에 "100줄 이하, 코멘트 없음, 클래스 5개 이하" 박기 |
...
정확한 직관이에요. 이게 v2 하네스의 미묘한 핵심입니다. AI가 코드를 *너무 잘* 만들면 throwaway가 깨집니다. 그래서 스킬에 명시적으로 "200줄 캡, 타입 힌트 없음, 코멘트 없음" 같은 제약을 박아둡니다.
