...
Stop with a short grouped question list if Stage 2 proceed is not confirmed or the learning evidence needed for the decision is absent. Write no other Stage 3 artifact. Complete by reporting the decision artifact and unresolved validation risk.
