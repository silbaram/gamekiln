...
Read the current stage artifact, learnings, killed hypotheses, playtest evidence, Top Risks, and iteration records when present. At Stage 4-5, also read `docs/game/production-plan.md`, `docs/game/3-scope-estimate.md`, relevant detail records, relevant current-batch implementation specs, and recorded production, build, QA, and playtest evidence; report absent inputs as evidence gaps. The preloaded skill owns the stage criteria and asset treatment.
