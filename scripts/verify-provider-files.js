...
const GEMINI_REQUIRED_CONTRACT_TERMS = Object.freeze({
  "spec-writer": [
    /docs\/game\/specs\/<name>\.md/,
    /one vertical-slice-validated system or content category/,
    /Purpose/,
    /Rules/,
    /Acceptance Criteria/,
    /References/,
    /State And Data/,
    /schema fields/,
    /Read every existing `Depends On` spec/,
    /Search existing specs for exact references/,
    /comparison axes/,
    /balance values/,
    /single source under `game\//,
    /Do not require evidence-source labels/,
    /Do not contradict the macro design or verified decisions/,
    /page cap/,
    /Open Questions/,
    /system absent from the vertical slice/,
  ],
  "scope-estimator": [
...
const AGENT_REQUIRED_TERMS = Object.freeze({
  "kill-arbiter": [
    /production-plan\.md/,
    /3-scope-estimate\.md/,
    /relevant current-batch implementation specs/,
  ...
  "spec-writer": [
    ...
    /short grouped question list/,
    /Rule-to-Acceptance-Criterion coverage/,
  ],
  "stage-router": [
    /production-plan/,
    /3-scope-estimate\.md/,
